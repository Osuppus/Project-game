...
namespace Mechanics
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                transform.position =
                    new Vector3(transform.position.x - moveSpeed * Time.deltaTime, transform.position.y);
            }
        ...
        private IEnumerator Dash()
        {
            ...
            rb.linearVelocity =
                new Vector2(transform.localScale.x * dashingPower,
                    0f); // Set the dash velocity in the direction the character is facing
            ...
            yield return
                new WaitForSeconds(dashingCooldown); // Wait for the cooldown period before allowing another dash
